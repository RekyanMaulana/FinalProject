...
{{csrf_field()}} 
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text" name="nama" type="text" class="form-control" value="{{$prod->nama}}">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text1" name="price" type="text" class="form-control" value="{{$prod->price}}">
    </div>
  </div>
  <div class="form-group row">
    <label for="text2" class="col-4 col-form-label">Stok</label> 
    <div class="col-8">
      <input id="text2" name="stok" type="number" class="form-control" value="{{$prod->stok}}">
    </div>
  </div>
  <div class="form-group row">
