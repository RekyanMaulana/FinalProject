    ...
    <div class="card-body">
        <table id="datatablesSimple" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo e($no++); ?></td>
                    <td><?php echo e($data->product->nama); ?></td>
...
<?php echo $__env->make('admin.layout.appadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FinalProject\resources\views/admin/detail_transaksi/index.blade.php ENDPATH**/ ?>