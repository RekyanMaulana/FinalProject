    ...
    <div>
        ...
        <div class="space-y-2">
            ...
            <p class="space-x-2">
                ...
                <span class="text-gray-600">{{$produk->penjual->nama_toko}}</span>
            </p>
            <p class="space-x-2">
        ...
        <form action="{{route('pesanan-store')}}" method="post">
            ...
            <div class="mt-4">
                ...
                <div class="flex border border-gray-300 text-gray-600 divide-x divide-gray-300 w-max">
                    <button id="minus" class="h-8 w-8 text-xl flex items-center justify-center cursor-pointer select-none">-</button>
                    <input id="quantity" name="quantity" class="h-8 w-14 text-base flex items-center justify-center text-center" value="0">
                    <button id="plus" class="h-8 w-8 text-xl flex items-center justify-center cursor-pointer select-none">+</button>
                </div>
            </div>
