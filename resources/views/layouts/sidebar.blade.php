...
<aside class="main-sidebar sidebar-light-danger elevation-4" >
    ...
    <a href="#" class="brand-link" style="text-align: center;">
        <div class="text-center mb-1">
            <img src="{{ url('assets/user/images/logo.png')}}" alt="AdminLTE Logo" width="50%" style="opacity: .8">
        </div>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{url('home_penjual')}}" class="nav-link {{($title == 'Dashboard') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{url('penjual')}}" class="nav-link {{($title == 'Data Penjual'  || $title == 'Edit Data Penjual') ? 'active' : '' }}">
